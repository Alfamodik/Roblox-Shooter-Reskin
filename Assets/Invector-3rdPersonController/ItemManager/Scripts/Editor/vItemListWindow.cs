        ...
        public virtual void OnGUI()
        {
            ...
            if (OnSelectItem == null)
            {
                ...
                if (inDragItens)
                {
                    ...
                    EditorGUILayout.HelpBox("You can add items from other lists by selecting other lists in the ProjectWindow, click on 'ShowCursor items in Hierarchy' and drag & drop the item to the field bellow", MessageType.Info);
