...
namespace Invector
{
    ...
    [vClassHeader("Draw/HideCursor Melee Weapons", "This component works with vItemManager, vWeaponHolderManager and vMeleeCombatInput", useHelpBox = true)]
    public class vDrawHideMeleeWeapons : vMonoBehaviour
    {
        ...
        [vHelpBox("Mute Lock input to Inventory when Lock method is called")]
