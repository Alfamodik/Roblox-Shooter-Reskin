...
namespace Invector.vCharacterController.AI
{
    ...
    public class vWaypointAreaEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            hotKeys = GUILayout.Toggle(hotKeys, hotKeys ? "HideCursor Hot Keys" : "ShowCursor Hot Keys", "button", GUILayout.ExpandWidth(true));
            if (hotKeys)
            {
                ...
                GUI.color = Color.white;
                GUILayout.Label("Mute click point position to way point selected");
                GUILayout.EndVertical();
                EditorGUILayout.Separator();
                ...
                GUI.color = Color.white;
                GUILayout.Label("Mute click point position to patrol point selected");
                GUILayout.EndVertical();
                EditorGUILayout.Separator();
            }
            EditorGUILayout.Separator();
