...
namespace Invector.vCharacterController.AI
{
    public class vSimpleMeleeAI_Animator : vSimpleMeleeAI_Motor
    {
        ...
        /// ps* Move Mute is the way your character will move, ATK_ID is the way your character will attack. You can have different locomotion animations and attacks.
        /// </summary>
