...
public static class vShooterMeleeInputGizmos
{
    ...
    static void DrawOptionsWindow(int id)
    {
        ...
        showAimPosition =EditorGUILayout.Toggle("ShowCursor Aim",showAimPosition);
        showBlockAim = EditorGUILayout.Toggle("ShowCursor Block Aim ", showBlockAim);
        showAimReference = EditorGUILayout.Toggle("ShowCursor Aim Reference", showAimReference);
