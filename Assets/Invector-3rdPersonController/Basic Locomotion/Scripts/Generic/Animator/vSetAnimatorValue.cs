...
{
    [vClassHeader("Mute Animator Value", useHelpBox = true, helpBoxText = "Use this component to set animator value using events")]
    public class vSetAnimatorValue : vMonoBehaviour
    {
        [vSelectableString("Mute Float exemple", "ParamenterName,Float,1.0")]
        [vSelectableString("Mute Integer exemple", "ParamenterName,Int,1")]
        [vSelectableString("Mute Bool exemple", "ParamenterName,Bool,true")]
        [vSelectableString("Mute Trigger exemple", "ParamenterName,Trigger,Mute")]
